...
std::string IMU_TOPIC1 = "IMU_TOPIC1";
int ROW, COL;
double TD;
int NUM_OF_CAM;
int STEREO;
...
std::string IMAGE0_TOPIC, IMAGE1_TOPIC, IMAGE2_TOPIC, IMAGE3_TOPIC, IMAGE4_TOPIC, IMAGE5_TOPIC;
...
void readParameters(std::string config_file)
{
    ...
    fsSettings["image2_topic"] >> IMAGE2_TOPIC;//todo 增加双目
    fsSettings["image3_topic"] >> IMAGE3_TOPIC;
    fsSettings["image4_topic"] >> IMAGE4_TOPIC;//todo 增加双目
    ...
    if(USE_IMU)
    {
        ...
        fsSettings["imu_topic1"] >> IMU_TOPIC1;
        if(IMU_TOPIC1.empty())
            IMU_TOPIC1 = "IMU_TOPIC1";
    ...
    {
        printf("num_of_cam should be 1, 2 or 4\n");
        assert(0);
    }
